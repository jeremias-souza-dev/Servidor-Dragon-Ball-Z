...
function creatureSayCallback(cid, type, msg)
   ...
   local talkUser = NPCHANDLER_CONVBEHAVIOR == CONVERSATION_DEFAULT and 0 or cid
	if msgcontains(msg, "chilled") then
		selfSay("Voce tem certeza que quer virar chilled ?", cid)
	...
	elseif (msgcontains(msg, "yes") and talkState[talkUser] == 1) and (getPlayerItemCount(cid, 9970) >= 500) then
        ...
        doPlayerAddItem(cid, 13491, 1)
		selfSay("Obrigado, Agora você podera virar chilled !", cid)
