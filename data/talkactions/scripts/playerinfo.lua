function onSay(cid, words, param, channel)
	...
	doPlayerPopupFYI(cid, "Information about player" ..
		...
		"\nStatus:" ..
			...
			"\nSkills:" ..
			"\nAttack Speed - " .. getPlayerSkillLevel(pid, SKILL_FIST) .. ", Weapon - " .. getPlayerSkillLevel(pid, SKILL_CLUB) .. ", Sword - " .. getPlayerSkillLevel(pid, SKILL_SWORD) .. ", Strenght - " .. getPlayerSkillLevel(pid, SKILL_AXE) ..
